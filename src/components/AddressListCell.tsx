...
export const AddressListCell = ({address,onPressDelete, onPress}:AddressCellProps) => {
    return(
       <TouchableOpacity 
       onPress={onPress}
       style={[styles.container,{borderColor: address.active ? colors.PrimaryColor:'white' }]}>
       <LocationIcon/>
